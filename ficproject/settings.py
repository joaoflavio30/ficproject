"""
Django settings for ficproject project.
...
SECRET_KEY = 'django-insecure-ekhz0lq9$15^idb4d8teb7x5s#@c%1yho*i!*&1)+x0kx!2&ic'
...
WSGI_APPLICATION = 'ficproject.wsgi.application'
